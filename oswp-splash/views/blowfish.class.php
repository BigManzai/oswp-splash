...
// Veraltet: Methoden mit demselben Namen wie ihre Klasse werden in einer zukünftigen Version von PHP keine Konstruktoren sein. 
// Blowfish hat einen veralteten Konstruktor in [...] [...] Zeile 237.
   ...
   public function KeySetup($key) {
	...
	0xb74e6132, 0xce77e25b, 0x578fdfe3, 0x3ac372e6);
      ...
      for($i=0;$i<count($this->pbox);$i++)
         $this->pbox[$i] ^= $key[$i%count($key)]; // Warning: count(): Parameter must be an array or an object that implements Countable
